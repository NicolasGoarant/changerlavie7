...
ActiveRecord::Schema.define(version: 2020_03_06_191623) do
  ...
  create_table "articles_libraries", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "library_id"
    t.bigint "article_id"
    t.index ["article_id"], name: "index_articles_libraries_on_article_id"
    t.index ["library_id"], name: "index_articles_libraries_on_library_id"
  end
